...
const packages = [
  ...
  },
  {
    ...
    features: [
      ...
      "Guest arrival music (up to 1 hour before ceremony)",
      "All ceremony music",
  ...
  },
  {
    ...
    features: [
      ...
      "Photo Booth with backdrops, wedding props & attendant",
      "Cold Spark Machines - wireless, 8-10ft spark effects",
      "Venue Uplighting - wireless, weather-resistant LED uplights",
    ],
    popular: false,
    isBundle: true,
  },
  {
    ...
    features: [
      ...
      "Photo Booth with wedding props, large backdrop & attendant",
      "Cold Spark Machines - stylish wireless spark effects",
      "Venue Uplighting - wireless uplights to match your theme",
    ],
    popular: false,
    isBundle: true,
  },
    ...
    <section id="packages" className="relative py-24 lg:py-32 bg-[#030508] overflow-hidden">
      ...
      <div className="px-6 lg:px-16">
        ...
        >
          ...
          <p className="text-white/50 text-lg mt-8 max-w-3xl mx-auto">
            All packages include setup, breakdown, travel, and taxes plus clean music edits, online planning tools, and full insurance. Flexible payment and e-signing available.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-6 lg:gap-8 max-w-5xl mx-auto">
          {packages.map((pkg, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className={`relative glass rounded-2xl p-8 ${pkg.popular ? "border-[#789dbe]/50 glow" : ""}`}
            >
              {pkg.popular && (
              ...
              <Link
                ...
                className={`block w-full text-center py-4 rounded-full text-xs uppercase tracking-[0.2em] font-medium transition-all duration-500 ${
                  pkg.popular
                    ? "bg-[#789dbe] text-[#030508] hover:bg-white hover:shadow-[0_0_30px_rgba(120,157,190,0.5)]"
        ...
        >
          <p className="text-white/50 mb-4">Need something custom?</p>
          <Link
            href="/get-quote"
