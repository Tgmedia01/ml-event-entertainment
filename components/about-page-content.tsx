...
const awards = [
  ...
  {
    src: "/images/award-charlestons-choice.png",
...
const team = [
  {
    ...
    image: "/images/mikey-lee-mc-microphone.png",
    bio: "Mikey Lee is the founder and lead DJ of ML Event Entertainment, bringing over 15 years of full time DJ experience to weddings, private events, and parties around the world. His career has taken him across Europe, the United States, and aboard some of the largest cruise ships sailing today covering London, Ibiza, Miami, and Los Angeles along the way. After meeting his now wife Katelin, Mikey made the move to Charleston, South Carolina, a city that inspired him to launch his own company. What began as a passion project quickly grew into one of the Lowcountry's most awarded entertainment services.",
  },
  {
    name: "Katelin McTigue",
    role: "Director of Operations",
    image: "https://mlevententertainment.com/wp-content/uploads/2025/07/Katelin-M-Headshots-scaled.png",
    bio: "Katelin McTigue is the Director of Operations at ML Event Entertainment and the organisational force behind the scenes. As the wife of founder Mikey Lee, she plays a key role in the client experience. Katelin's background in event planning and sales brings a wealth of experience to her role, allowing her to expertly guide clients with professionalism, warmth, and efficiency. Her strong communication skills and attention to detail ensure that every event starts off on the right foot.",
  },
  {
    name: "DJ Davis",
    role: "DJ & MC",
