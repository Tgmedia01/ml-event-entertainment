...
const faqCategories = [
  ...
  },
  {
    ...
    questions: [
      {
        question: "What is the 360 Photo Booth?",
        answer:
          "Our 360 Photo Booth is a spinning platform that creates stunning slow-motion videos of your guests. It's become one of the most popular add-ons and creates incredible shareable content.",
      },
      {
