...
const services = [
  ...
  },
  {
    number: "03",
    title: "Photo Booth",
    description: "Our Modern open-air booth with touchscreen display, instant HD prints, and digital sharing will make the best centrepiece your guests will never leave.",
