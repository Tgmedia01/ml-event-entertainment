        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="text-white/70 text-lg leading-relaxed mb-4">
              We pride ourselves on taking the stress out of YOUR event!
            </p>
            <p className="text-white/50 leading-relaxed">
              After all, music should be the fun part RIGHT! THATS WHERE WE COME IN! Whether you are looking for
              romantic ceremony tunes, a high energy dance floor, or elegant background music during dinner, our
              professional DJs tailor every moment to fit your vision.
            </p>
          </motion.div>
