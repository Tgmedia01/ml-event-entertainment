...
export function HeroSection() {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden max-w-full">
      ...
      {/* Content */}
      <motion.div style={{ opacity, y }} className="relative z-10 h-full flex flex-col justify-end pb-32 px-4 sm:px-6 lg:px-16 w-full overflow-hidden">
        <div className="max-w-none">
          ...
          >
            ...
            THAN JUST
            <br />
            <span className="italic text-[#789dbe] text-glow">TURN UP</span>
          </motion.h1>
