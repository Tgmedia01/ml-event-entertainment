    ...
    <>
      ...
      <section ref={containerRef} className="relative h-[400vh] bg-[#004563]/20 hidden lg:block">
        <div className="sticky top-0 h-screen overflow-hidden">
          ...
          {/* Cards - positioned below the header */}
          <div className="absolute bottom-24 left-0 w-full h-[420px]">
                ...
                >
                  <div className="glass rounded-3xl h-full p-8 lg:p-12 flex flex-col justify-between group hover:bg-[#789dbe]/5 transition-colors duration-500 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                      ...
                      <a href={addon.href} className="flex items-center gap-4 text-[#789dbe] text-sm uppercase tracking-[0.2em] group/link">
                        <span className="group-hover/link:text-white transition-colors duration-300">Find out more</span>
                        <span className="w-8 h-[0.5px] bg-[#789dbe] group-hover/link:w-16 transition-all duration-500" />
                      </a>
                    </div>
                  </div>
                </motion.div>
