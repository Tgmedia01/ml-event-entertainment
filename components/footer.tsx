...
export function Footer() {
  ...
  const socialLinks = [
    ...
    { icon: Youtube, href: "https://www.youtube.com/@mlevententertainment", label: "YouTube" },
  ...
  const serviceLinks = [
    ...
    { label: "Photo Booth", href: "/services" },
    ...
    <footer className="py-16 lg:py-24 px-6 lg:px-16 border-t border-[#789dbe]/10 bg-[#030508]">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="inline-block mb-6" data-cursor="pointer">
              <img
                src="/ml-event-entertainment-elegant-wedding-dj-logo-whi.jpg"
            ...
            <div className="space-y-2">
              ...
              <p className="text-white/30 text-sm pl-7">Charleston, SC 29464</p>
            </div>
          </div>
        ...
        <div className="pt-8 border-t border-[#789dbe]/10 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <p className="text-white/30 text-xs uppercase tracking-[0.2em]">Mount Pleasant, Charleston SC</p>
        </div>
      </div>
    </footer>
  )
